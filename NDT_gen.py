...
# path = '/media/cyw/Backup Plus/datasets/SemanticKitti/sequences/01/'
path = '/home/cyw/CYW/Datasets/SemanticKitti/sequences/01/'
semantic ='labels'
...
# for i in [1,100,200]:
    ...
    while len(voxel_xyz) < target_cell_size:
        vox_sz -= 0.005
        voxel_xyz, inv_ids = downsample_point_cloud(clean_xyz, vox_sz)
